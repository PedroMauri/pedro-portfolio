...
**Activities:** Competitor analysis: features, strengths, weaknesses, and gaps. Defined Lean UX personas (Influencer/Admin, Moderator, Active Member) with motivations, behaviors, and use scenarios, then refined them through prototype tests with influencers.
