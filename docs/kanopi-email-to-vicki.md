# Email draft — Kanopi (Vicki)

**To:** Vicki Drever  
**Subject:** Re: Contract Senior UX/UI Designer: written responses (Pedro Mauri)

Copy everything below the line into the email body.

---

Hi Vicki,

Thank you again for the follow-up questions.

My written responses are included in the body of this email below. To make them easier to follow, I also put the same answers on a private page with the process images and supporting visuals:

https://pedromauri.com/share/kanopi
Password: 1234

I chose Yethos as my primary example because it follows the same phase structure you asked about (Discovery, Content Strategy, UX Strategy, and Visual Design), end to end on a community-focused platform where I led from research through polished UI. It’s the clearest demonstration of how I approach website and product strategy work.

Portfolio project: https://pedromauri.com/projects/yethos-community-discovery

Please use whichever format works best for you.
...
1) Approach across a project

Project Scope / Workflow
(See diagram on the share page.)
...
2. Validate later in the loop: After the first prototype existed, we ran quick tests with influencers and refined the personas from that feedback (Lean UX), so Discovery hypotheses were checked before locking Visual Design.

1b. Content Strategy

Goals: Define what content and structure users need to evaluate and participate in a community without hunting across pages.

Activities: Mapped platform content into a clear hierarchy: Community → Channel → Topic, plus profiles, notifications, and moderation. Defined core pages (home/discovery, community overview, channel, profile) and what each should surface first.

Deliverables: Information hierarchy, core page definitions, navigation model (top bar + sidebar).

Into the next phase: Hierarchy and page jobs became the brief for flows, wires, and UI.

Information Architecture

We organized the web MVP around Community → Channel → Topic so discovery and participation had a clear home before mobile adaptation. The hierarchy on the share page became the brief for flows and UI.

1c. UX Strategy

Goals: Make creation and participation flows intuitive for admins, moderators, and members.

Activities: Mapped admin/mod flows (community setup, members, reports, statistics, requests). Built interactive prototypes for create community, create channels, and create topics. Ran usability testing and adjusted before final UI polish.

Deliverables: User flows, clickable prototypes, usability revisions.

Into the next phase: Testing validated what to keep in the MVP vs mark “not yet,” and which interactions needed clearer hierarchy in UI.

User Flow Mapping

A key user flow for the web MVP (Community Dashboard) is on the share page, along with the interactive prototype:
https://www.figma.com/proto/H5HP7S1xWwoWA9gotybIC0/Yethos---Screens

1d. Visual Design

Goals: A distinct, community-first brand and UI that supports clear CTAs and long sessions.
...
(Brand guidelines and hi-fi evolution are on the share page.)
...
For complex UI I document behavior and constraints and share with the team, especially the PM, for review before build. On Yethos, I wrote a Community Box spec so design, PM, and engineering stay aligned (example on the share page).
...
The types of challenges you are especially well suited to solve: Taking a client’s early vision (sketches, references, or rough ideas) and turning it into a clear structure on paper, then into screens that still honor what they want while staying logical toward the end goal.
...
How I built alignment: I brought the interview themes next to the Circle-style paid-only model and showed the trade-off: paywall at the community door vs. free entry with monetization one level deeper. We aligned on free communities + paid channels for the presentation MVP.
