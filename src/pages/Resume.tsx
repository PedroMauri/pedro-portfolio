...
export default function Resume() {
  return (
    <section className="mx-auto max-w-3xl px-5 py-16 text-center sm:px-8 sm:py-24 lg:text-left">
      ...
      <div className="mt-10 rounded-[1.75rem] border border-border bg-cream p-8 text-center lg:text-left">
        <div className="mx-auto flex size-14 items-center justify-center rounded-2xl bg-white text-accent-dark shadow-sm lg:mx-0">
